                        ...
                        <div class="flex flex-wrap">
                            <a wire:navigate href="{{ url('product/' . $product->id) }}"
                                ...
                                <div class="w-7/12 p-0 m-0">
                                    ...
                                    @php
                                        $price =
                                            $product->productSize[0]->metal_price +
                                            $product->productSize[0]->gemstone_price +
                                            $product->productSize[0]->making_charges +
                                            $product->productSize[0]->gst;
                                    @endphp
                    ...
                    <div class="bg-white shadow-md rounded-lg mx-1 mb-1 p-1">
                        <form action="{{ url('addReview') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="flex flex-wrap -mx-2">
                                ...
                                <button type="submit"
                                    class="bg-[#5C3422] text-white px-4 py-2 rounded mx-auto my-3 hover:bg-[#4a2b1b]">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
