                ...
                @if(Auth::user())
                    ...
                    @empty
                        <div class="text-center py-8">
                            ...
                            <a href="/all-product" class="mt-3 inline-flex items-center px-4 py-2 bg-green-600 text-white rounded hover:bg-green-800 transition">Start Shopping</a>
                        </div>
                    @endforelse
                @endif
            </div>
                ...
                @if(Auth::user())
                    @forelse(Auth::user()->wishlists as $wishlist)
                        <div class="bg-white shadow-md rounded-lg mb-3 p-3 relative">
                            <a href="{{ url('product/' . $wishlist->id) }}" class="flex items-center text-gray-900 no-underline">
                                <div class="w-1/3">
                ...
                @if(Auth::user())
                    ...
                    @forelse(Auth::user()->carts as $cart)
                        <div class="bg-white shadow-md rounded-lg mb-3 p-3 relative" id="cart-item-{{ $cart->product_id }}">
                            <a href="{{ url('product/' . $cart->id) }}" class="flex items-center text-gray-900 no-underline">
                                <div class="w-1/3">
                    ...
                    @if(Auth::user()->carts->count() > 0)
                        <div class="bg-white shadow-md rounded-lg p-4 mt-4">
                            ...
                            <a href="/shop-all" class="mt-3 w-full inline-flex justify-center items-center px-4 py-2 bg-green-600 text-white rounded hover:bg-green-800 transition">Shop Now</a>
                        </div>
                    @endif
                @endif
            </div>
