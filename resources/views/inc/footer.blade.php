<footer class="py-5 text-white bg-pink-400">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div>
                ...
                <p class="text-sm">PAGPRIYA by Ojas Jewel Emporium<br>3013-15-A, First Floor, Gali No. 19 Ranjit Nagar,
                    New Delhi-110008</p>
            </div>
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2">
                    <ul class="space-y-2">
                        <li class="text-sm hover:underline"><a wire:navigate href="{{ url('subcategory/1') }}">Rings</a>
                        </li>
                        <li class="text-sm hover:underline"><a wire:navigate
                                href="{{ url('subcategory/6') }}">Necklace</a></li>
                        <li class="text-sm hover:underline"><a wire:navigate
                                href="{{ url('subcategory/4') }}">Earings</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="text-sm mt-4 border">
        <p class="text-justify px-2 py-2">Silver Jewellery Collection
            ...
            Jewellery Shopping | Silver Shop | Pure Silver | Silver Pendant | Fine Silver Jewellery | Silver Necklace
            ...
            Online | Sterling Jewellery | Pure Silver Jewellery | Cheap Silver Jewellery | Silver Necklace And Earring
            Set | 925 Jewellery | Silver Store | Silver 925 Jewellery | Silver Jewellery Online India | Online Silver
            ...
            Silver Collection | Gold And Silver Necklace Together | Gold And Silver Earrings Together | Sterling Silver
            ...
            Necklace For Women Silver | 925 Sterling Silver Necklace | Sterling Silver Necklace Set | Silver Ornaments
            Online | Sterling Silver Jewellery | Silver Pendant For Women | Sterling Silver Women's Jewellery | Buy
            Silver Earrings Online | Buy Silver Necklace | Silver Necklace And Bracelet Set | Sterling Silver Necklace
