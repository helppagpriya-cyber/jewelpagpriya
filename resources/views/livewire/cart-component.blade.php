                ...
                @if(Auth::user())
                    ...
                    @if(Auth::user()->carts->count() > 0)
                        <div class="bg-white shadow-md rounded-lg p-4 mt-4">
                            ...
                            <a href="/shop-all" class="mt-3 w-full inline-flex justify-center items-center px-4 py-2 bg-brand text-white rounded hover:bg-brand-hover transition">Shop Now</a>
                        </div>
                    @endif
                @endif
            </div>
